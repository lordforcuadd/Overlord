...
switch ($ToggleName) {
    ...
    "disableOneDrive" {
        ...
        # Si lo estamos desactivando, matamos el proceso de raíz para que desaparezca al instante
        if ($IsEnabled) {
    ...
    "enableGameMode" {
        ...
        # Opcional pero recomendado: Asegurar que el DVR de capturas siga apagado aunque el GameMode se encienda
